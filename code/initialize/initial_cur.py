...
def init():
    ...
    f = open('./origin_data_zh/literal_data/train_literal_long.txt', 'r')
    ...
    f = open('./origin_data_zh/literal_data/test_literal_long.txt', 'r')
    ...
    np.save('./data/vec_literal.npy', vec)
    np.save('./data/train_x_literal.npy', train_x)
    np.save('./data/train_y_literal.npy', train_y)
    np.save('./data/testall_x_literal.npy', test_x)
    np.save('./data/testall_y_literal.npy', test_y)
    ...
    np.save('./data/pone_test_x_literal.npy', pone_test_x)
    np.save('./data/pone_test_y_literal.npy', pone_test_y)
    np.save('./data/ptwo_test_x_literal.npy', ptwo_test_x)
    np.save('./data/ptwo_test_y_literal.npy', ptwo_test_y)
    np.save('./data/pall_test_x_literal.npy', pall_test_x)
    np.save('./data/pall_test_y_literal.npy', pall_test_y)


def seperate():
    print 'reading training data'
    x_train = np.load('./data/train_x_literal.npy')
    ...
    print 'train_word', train_word.size
    np.save('./data/train_word_literal.npy', train_word)
    np.save('./data/train_pos1_literal.npy', train_pos1)
    np.save('./data/train_pos2_literal.npy', train_pos2)

    print 'reading p-one test data'
    x_test = np.load('./data/pone_test_x_literal.npy')
    ...
    np.save('./data/pone_test_word_literal.npy', test_word)
    np.save('./data/pone_test_pos1_literal.npy', test_pos1)
    np.save('./data/pone_test_pos2_literal.npy', test_pos2)

    print 'reading p-two test data'
    x_test = np.load('./data/ptwo_test_x_literal.npy')
    ...
    test_pos1 = np.array(test_pos1)
    test_pos2 = np.array(test_pos2)
    np.save('./data/ptwo_test_word_literal.npy', test_word)
    np.save('./data/ptwo_test_pos1_literal.npy', test_pos1)
    np.save('./data/ptwo_test_pos2_literal.npy', test_pos2)

    print 'reading p-all test data'
    x_test = np.load('./data/pall_test_x_literal.npy')
    ...
    test_pos1 = np.array(test_pos1)
    test_pos2 = np.array(test_pos2)
    np.save('./data/pall_test_word_literal.npy', test_word)
    np.save('./data/pall_test_pos1_literal.npy', test_pos1)
    np.save('./data/pall_test_pos2_literal.npy', test_pos2)

    print 'seperating test all data'
    x_test = np.load('./data/testall_x_literal.npy')
    ...
    np.save('./data/testall_word_literal.npy', test_word)
    np.save('./data/testall_pos1_literal.npy', test_pos1)
    np.save('./data/testall_pos2_literal.npy', test_pos2)


def getsmall():
    print 'reading training data'
    word = np.load('./data/train_word_literal.npy')
    print 'word', word.size
    pos1 = np.load('./data/train_pos1_literal.npy')
    pos2 = np.load('./data/train_pos2_literal.npy')
    y = np.load('./data/train_y_literal.npy')
    ...
    for i in range(len(word)):
        lenth = len(word[i])
        if lenth > 75:
            for start in xrange(0, len(word[i]), 75):
    ...
    print 'new_word', new_word.size

    np.save('./data/small_word_literal.npy', new_word)
    np.save('./data/small_pos1_literal.npy', new_pos1)
    np.save('./data/small_pos2_literal.npy', new_pos2)
    np.save('./data/small_y_literal.npy', new_y)


# get answer metric for PR curve evaluation
def getans():
    test_y = np.load('./data/testall_y_literal.npy')
    eval_y = []
    for i in test_y:
        eval_y.append(i[1:])
    allans = np.reshape(eval_y, (-1))
    np.save('./data/allans_literal.npy', allans)
