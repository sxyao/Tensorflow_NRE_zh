...
def main(_):
    ...
    pathname = "/home/shuxiny/home/shuxiny/Tensorflow_NRE_zh/model/ATT_GRU_final_-"
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            testlist = [14000, 13500, 13000, 12500, 11500, 11000, 10000, 9000]
            for model_iter in testlist:
                ...
                test_y = np.load('./data/pone_test_y_newtvsplit.npy')
                test_word = np.load('./data/pone_test_word_newtvsplit.npy')
                test_pos1 = np.load('./data/pone_test_pos1_newtvsplit.npy')
                test_pos2 = np.load('./data/pone_test_pos2_newtvsplit.npy')
                ...
                test_y = np.load('./data/ptwo_test_y_newtvsplit.npy')
                test_word = np.load('./data/ptwo_test_word_newtvsplit.npy')
                test_pos1 = np.load('./data/ptwo_test_pos1_newtvsplit.npy')
                test_pos2 = np.load('./data/ptwo_test_pos2_newtvsplit.npy')
                eval_pn(test_y, test_word, test_pos1, test_pos2, test_settings)

                print 'Evaluating P@N for all'
                if itchat_run:
                    itchat.send('Evaluating P@N for all', FLAGS.wechat_name)
                test_y = np.load('./data/pall_test_y_newtvsplit.npy')
                test_word = np.load('./data/pall_test_word_newtvsplit.npy')
                test_pos1 = np.load('./data/pall_test_pos1_newtvsplit.npy')
                test_pos2 = np.load('./data/pall_test_pos2_newtvsplit.npy')
                eval_pn(test_y, test_word, test_pos1, test_pos2, test_settings)
                ...
                test_word = np.load('./data/testall_word_newtvsplit.npy')
                test_pos1 = np.load('./data/testall_pos1_newtvsplit.npy')
                test_pos2 = np.load('./data/testall_pos2_newtvsplit.npy')
                allprob = []
                acc = []
                for i in range(int(len(test_word) / float(test_settings.big_num))):
                    prob, accuracy = test_step(test_word[i * test_settings.big_num:(i + 1) * test_settings.big_num],
                ...
                np.save('./out/allprob_iter_' + str(current_step) + '_newtvsplit.npy', allprob)
                allans = np.load('./data/allans_newtvsplit.npy')
